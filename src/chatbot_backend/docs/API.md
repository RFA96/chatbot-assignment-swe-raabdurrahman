...
A RESTful API for e-commerce operations built with FastAPI, providing customer authentication, product catalog browsing, and shopping cart functionality.
...
5. [API Endpoints](#api-endpoints)
   ...
   - [Shopping Cart](#shopping-cart)
     ...
     - [Get Cart Item Count](#get-cart-item-count)
   - [Customer Addresses](#customer-addresses)
     - [Get Addresses](#get-addresses)
     - [Get Address by ID](#get-address-by-id)
   - [Vouchers](#vouchers)
     - [Get Active Vouchers](#get-active-vouchers)
...
- Voucher/coupon support with validation
- Order management with status tracking
- **Inventory/Stock Management** with audit trail
- Low stock alerts and monitoring
- **AI Shopping Assistant** with tool calling capabilities
- Chat session persistence with token usage tracking
- Product images via Picsum placeholder service
